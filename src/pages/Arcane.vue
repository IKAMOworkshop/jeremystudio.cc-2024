<template>
    <div>
        ...
        <div class="section-container content-hidden">
            <ImageContainer>
                <img src="@/assets/arcane/model_collage.png" alt="A collage of models used for this website, which include the hero robot head, a cat, and a simplified keyboard" class="contained-image" loading="lazy">
            </ImageContainer>
        </div>
        ...
        <div class="section-container content-hidden">
            <ImageContainer>
                <img src="@/assets/arcane/design_pillar.png" alt="A diagram showing the base pillars that I consider when designing a website, especially a portfolio" class="contained-image" loading="lazy">
            </ImageContainer>
        </div>
        ...
        <div class="section-container content-hidden">
            <ImageContainer>
                <img src="@/assets/arcane/visual_research.png" alt="A collage of all the referenced screenshots from other people's websites" class="contained-image" loading="lazy">
            </ImageContainer>
        </div>
        ...
        <div class="section-container content-hidden">
            <ImageContainer>
                <img src="@/assets/arcane/vue_three.png" alt="A image showing the Vue.js and Three.js logo" class="contained-image" loading="lazy">
            </ImageContainer>
        </div>
        ...
        <div class="section-container flex flex-column gap-36">
            <img src="@/assets/arcane/blender.png" alt="A screenshot from Blender showing the modeling process of the robot head" class="project-image content-hidden" loading="lazy">
            <div class="project-columns flex gap-36 content-hidden">
                <div class="flex flex-column gap-36">
                    <img src="@/assets/arcane/import_model_code.png" alt="A code snippet showing the importing and loading of models" class="project-image" loading="lazy">
                </div>
                <div class="flex flex-column gap-36">
                    <img src="@/assets/arcane/animating_model_code.png" alt="A code snippet showing the code of updating the position of the models, which animate them using sin functions and time" class="project-image" loading="lazy">
                </div>
            </div>
        </div>
        ...
        <div class="section-container project-columns flex gap-36 content-hidden">
            <div class="flex flex-column gap-36">
                <img src="@/assets/arcane/setting_scene_code.png" alt="A code snippet showing the function that sets up the various scenes for the multi-render" class="project-image" loading="lazy">
            </div>
            <div class="flex flex-column gap-36">
                <img src="@/assets/arcane/render_section_code.png" alt="A code snippet showing the slicing code to tell the canvas to check for render target and render the corrisponding scene" class="project-image" loading="lazy">
            </div>
        </div>
        ...
        <div class="section-container flex flex-column gap-36">
            ...
            <div class="project-columns flex gap-36 content-hidden">
                <div class="flex flex-column gap-36">
                    <img src="@/assets/arcane/transition_code.png" alt="A code snippet showing the GSAP animation code for page transitions" class="project-image" loading="lazy">
                </div>
                <div class="flex flex-column gap-36">
                    <img src="@/assets/arcane/scroll_code.png" alt="A code snippet showing the GSAP animation code for scroll triggers" class="project-image" loading="lazy">
                </div>
            </div>
        </div>
